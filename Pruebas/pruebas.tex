...
\end{itemize}
 ...
 \hline
    \multicolumn{2}{|c|}{Continuación de la tabla \ref{tab:TablaChequeoRequerimientos}}\\
    \hline
    \multicolumn{1}{| c |}{Requerimiento} &\multicolumn{1}{| c |}{Verificación}\\
    \hline
 \endhead
 ...
 \endlastfoot
        ...
        \hline
        %\multicolumn{1}{|c|}{RNF001} & Los insumos de hardware utilizados para la construcción del sistema fueron seleccionados de forma tal de disminuir el costo total sin complejizar la construcción. . Mencionado en el capítulo \textit{\textbf{Software}}. \\
        %\hline
