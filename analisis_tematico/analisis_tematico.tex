\chapter{ Marco temático: Producción de cerveza artesanal}
    ...
    \section{Maceración}
        ...
        \par La activación de cada una de las enzimas esta regida principalmente por la temperatura y pH de la solución. Debido a que su comportamiento es una suma de factores, la función de activación tiene una forma similar obtenida a la campana gaussiana. Entonces para conocer la activación se utiliza la fórmula:
        \begin{equation}
            Act = \exp{- (t_e - t)^2} \cdot \exp{- (pH_e - pH)^2}
        \end{equation}